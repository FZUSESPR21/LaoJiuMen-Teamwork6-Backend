...
public class SendMailUtil {
    ...
    public static String sendEmailAccount = "921509141@qq.com";
    // 发件人的邮箱的授权码(自己在邮箱服务器中开启并设置)
    public static String sendEmailPassword = "rhvmbbbsdzpebdaa";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,
        ...
        // 设置发件人姓名和编码格式
        message.setFrom(new InternetAddress(sendMail, "软件工程课程网站", "UTF-8"));
